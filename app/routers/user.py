...
def update_user(user_id: int, user_in: UserUpdate) -> None:
    user_manager = UserManager()
    updated_user = user_manager.update_user(user_id=user_id, user_data=user_in.model_dump(exclude_unset=True))
    return updated_user
